<template>
  <div>
    <reset-parts />
    <div class="notify">
      <p>くろくろわーくすは<strong>現在進行系で実装中</strong>です。一部表示が崩れたり、表示できないコンテンツがございます。(2017/09/10 17:00 更新)</p>
    </div>
    <nuxt/>
...
<script>
  import ResetParts from '~components/parts/reset.vue'
  export default {
    components: {
      ResetParts
    },
...
<style lang="scss">
  ...
  @font-face {
    ...
    font-style: normal;
    font-weight: 400;
    src: url(//fonts.gstatic.com/ea/mplus1p/v1/Mplus1p-Regular.woff2) format('woff2'),
  ...
  body {
    ...
    font-size: 16px;
    h1, h2, h3 {
      font-family: 'JK Gothic M', 'Mplus 1p', 'Hiragino Kaku Gothic ProN', 'Meiryo', sans-serif;
    }
    a {
      color: #555555;
